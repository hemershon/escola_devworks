...
class TurmasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create turma" do
    assert_difference('Turma.count') do
      post turmas_url, params: { turma: { aluno: @turma.aluno, materia: @turma.materia, professor: @turma.professor, turma: @turma.turma, turno: @turma.turno } }
    end
  ...
  test "should update turma" do
    patch turma_url(@turma), params: { turma: { aluno: @turma.aluno, materia: @turma.materia, professor: @turma.professor, turma: @turma.turma, turno: @turma.turno } }
