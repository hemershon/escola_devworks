...
class ProfessorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post professors_url, params: { professor: { horario: @professor.horario, materia: @professor.materia, nome: @professor.nome, turma: @professor.turma } }
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { horario: @professor.horario, materia: @professor.materia, nome: @professor.nome, turma: @professor.turma } }
