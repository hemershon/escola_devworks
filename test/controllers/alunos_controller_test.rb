...
class AlunosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aluno" do
    assert_difference('Aluno.count') do
      post alunos_url, params: { aluno: { idade: @aluno.idade, materia_id: @aluno.materia_id, nome: @aluno.nome, professor_id: @aluno.professor_id, turma_id: @aluno.turma_id } }
    end
  ...
  test "should update aluno" do
    patch aluno_url(@aluno), params: { aluno: { idade: @aluno.idade, materia_id: @aluno.materia_id, nome: @aluno.nome, professor_id: @aluno.professor_id, turma_id: @aluno.turma_id } }
